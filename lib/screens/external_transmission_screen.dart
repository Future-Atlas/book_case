...
* メールアドレス
* 電話番号（電話番号認証を導入し、利用者が入力した場合）
* UIDその他のアカウント識別子
* Google、Xその他の認証providerに関する情報
* 外部サービス上の利用者識別子
* アカウントの作成日時
* 最終ログイン日時
...
運営者は、利用者のGoogleアカウント又はXアカウントのパスワードを取得しません。認証用トークンは、ログイン状態の維持及び認証処理に必要な範囲で取り扱われます。
...
* お問い合わせ、通報、権利侵害に関する申出及び開示等の請求への対応
* 利用者による退会及びアカウント削除
